...
|---|---|---|---|---|---|
| NORMAL_PAYMENT | APPROVE | APPROVE | 0.0918 | PASS | Genuine small payment; nothing suspicious. |
...
| UNREGISTERED_DEVICE | HOLD | HOLD | 0.0213 | PASS | New device with zero history: fraud-service's low-signal guard (FraudScoringService) downgrades any would-be APPROVE to HOLD_FOR_REVIEW — a brand-new device never auto-approves. |
